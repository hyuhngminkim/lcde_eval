...
# for dataset in fb_200M_uint64_shuffle; do
...
# for i in osm_cellids_200M_uint64_shuffle,4; do
#   IFS=","
#   set -- $i
#   dataset=$1
#   variant=$2
...
index=PGM
index_option=INDEX_${index}
# books_200M_uint64_shuffle,64 fb_200M_uint64_shuffle,32 wiki_ts_200M_uint64_shuffle,256 osm_cellids_200M_uint64_shuffle,8
for i in books_200M_uint64_shuffle,64 wiki_ts_200M_uint64_shuffle,256; do
  IFS=","
  set -- $i
  dataset=$1
  variant=$2
...
# make -j 8
# # books_200M_uint64_shuffle fb_200M_uint64_shuffle wiki_ts_200M_uint64_shuffle osm_cellids_200M_uint64_shuffle
# for dataset in osm_cellids_200M_uint64_shuffle; do
#   echo "${index} write on ${dataset}"
#   until ./ycsb --print -w --dataset ${dataset} > ../writes/write_${dataset}_${index}_${curtime}.txt
#   do
#     echo "Retrying write"
