...
C     https://cran.r-project.org/package=lsei
C     with units 3., 7., and PNNLS.FOR (the contents were not changed)
C     (Note by Hyuhng Min Kim, School of Computing, Korea Advanced Institute of
C     Science and Technology, South Korea. Email: hminkim@kaist.ac.kr
C     ==============================================================
