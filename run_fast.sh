...
for dataset in wiki_ts_200M_uint64_shuffle; do
...
for i in wiki_ts_200M_uint64_shuffle,5; do
  IFS=","
  set -- $i
  dataset=$1
  variant=$2
...
for i in wiki_ts_200M_uint64_shuffle,32; do
  IFS=","
  set -- $i
  dataset=$1
  variant=$2
...
for i in wiki_ts_200M_uint64_shuffle,2; do
  IFS=","
  set -- $i
  dataset=$1
  variant=$2
